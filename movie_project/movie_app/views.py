...
def movie_detail(request, pk):
    ...
    return render(request, "movie_app/movie_detail.html", {
        "movie": movie,
...
def watchlist_toggle(request, pk):
    ...
    if not created:
        wl.delete()
    return redirect(reverse("movie_app:movie_detail", args=[pk]))
...
def my_watchlist(request):
    ...
    return render(request, "movie_app/my_watchlist.html", {"movies": movies})
